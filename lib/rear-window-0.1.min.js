Rear=function(o,options){addEvent=function(obj,type,fn){var obj=(obj.constructor===String)?document.getElementById(obj):obj;if(obj.attachEvent){obj['e'+type+fn]=fn;obj[type+fn]=function(){obj['e'+type+fn](window.event)};obj.attachEvent('on'+type,obj[type+fn]);}else obj.addEventListener(type,fn,false);}
...
return typeof(v);}
var cssOnload=function(id,callback){setTimeout(function listener(){var el=document.getElementById(id),comp=el.currentStyle||getComputedStyle(el,null);if(comp.display==='none')
callback();else
...
if(typeof(window.rearwindow)!='undefined'){var body=document.getElementsByTagName('body')[0];body.removeChild(window.rearwindow);var old_css;if(old_css=document.getElementById('rear-window-css')){body.removeChild(old_css);}}
var css_href;if(realTypeOf(options)=='object'&&options.hasOwnProperty('css')){css_href=options.css;}else if(arguments.length==1&&realTypeOf(o)=='object'&&o.hasOwnProperty('css')){css_href=o.css;}else{css_href='https://github.com/lukes/rear-window.js/raw/master/lib/rear-window.css';}
var css=document.createElement('link');css.rel='stylesheet';css.href=css_href;css.type='text/css';var body=document.getElementsByTagName('body')[0];body.appendChild(css);var cssloader=document.createElement('div');cssloader.id='rear-window-cssloaded';body.appendChild(cssloader);if(typeof(o)=='undefined'||typeof(o)=='object'){o='window';}
cssOnload('rear-window-cssloaded',function(){init(o);});}